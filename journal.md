...
# March 30, 2026
Upsets can happen for a multitude of reasons,the team got lazy,let up pressure,lost momentum or the other team gained momentum, perhaps a key player got injured mid game. Its hard for any bracket making programs or just computers to calculate those variables because the chance of them happening are typically low.Theres no way I believe that a computer can calcualate injuries or a team just letting up. There are limits to computer generation and "guess'". They can calculate stats,points,efficiancy,and shots made all day and almost never mess up, but they cant predict what the player does to his/her body. Computers do what they are programmed, not predict the future.
# April 13,2026
Tech helped the mission succeed were the advanced communication systems that are now available to us, using real time data transmissions.Navigation and flight control also helped shift the balance in what we are able to complete in space. One obvious issue that Artemis came across was the planned transmission black out causing all communications to go dark as they passed the back of the moon. This issue could POSSIBLY be solved in the future by hypothetically launching a second smaller sattellite to orbit the moon thats only job is to recieve and send transmissions.
